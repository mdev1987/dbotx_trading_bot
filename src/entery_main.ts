...
//     lines.push(
//       `\u{1F6E1}\uFE0F Buy: \`${CONFIG.liveBuyEnabled ? "ENABLED" : "PAPER (disabled)"}\``,
//     );
//   }
...
//   if (
//     channelMode === "avesolanatokenscanner" ||
//     channelMode === "avesignalmonitor"
//   ) {
//     lines.push(
...
//         } catch (err) {
//           console.warn(
//             "[watchdog] Telegram health check failed — restarting:",
//             err,
//           );
//           await restartTelegram();
//         }
...
//   console.log(
//     `Total PnL      : $${report.totalProfitUsd.toFixed(2)} (${report.totalProfitPct.toFixed(2)}%)`,
//   );
