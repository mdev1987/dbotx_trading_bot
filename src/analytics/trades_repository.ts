...
import { positionEvent$ } from "../shared/trade_bridge";
...
export function startPersistence(): void {
  ...
  // Live mode has its own persistence (live/persistence.ts) — skip analytics DB
  if (CONFIG.liveMode) {
    console.log("[trades_repository] Live mode — analytics persistence skipped (live module handles its own)");
    return;
  }
